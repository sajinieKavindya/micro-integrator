...
public class OAuthConstants {
    ...
    public static final String OAUTH_CONFIG = "security_gateway.";
    public static final String JWT_OAUTH_CONFIG = OAUTH_CONFIG + "jwt.";
    public static final String AUTHORIZATION_HEADER = OAUTH_CONFIG + "authorization_header";
    public static final String TOKEN_CACHE_TIMEOUT = OAUTH_CONFIG + "token_cache_timeout";
    public static final String REMOVE_OAUTH_HEADERS_FROM_OUT_MESSAGE = OAUTH_CONFIG + "remove_oauth_headers_from_out_message";
    public static final String REVOCATION_PROVIDER = JWT_OAUTH_CONFIG + "revocation_provider";
    ...
    public static final String HTTP_CLIENT_CONFIG = OAUTH_CONFIG + "http_client.";
    public static final String HTTP_CLIENT_CONNECTION_TIMEOUT = HTTP_CLIENT_CONFIG + "connection_timeout";
    public static final String HTTP_CLIENT_SOCKET_TIMEOUT = HTTP_CLIENT_CONFIG + "socket_timeout";
    public static final String HTTP_CLIENT_REQUEST_TIMEOUT = HTTP_CLIENT_CONFIG + "request_timeout";
    public static final String PROXY_ENABLE = HTTP_CLIENT_CONFIG + "proxy_enabled";
    public static final String PROXY_HOST = HTTP_CLIENT_CONFIG + "proxy_host";
    public static final String PROXY_PORT = HTTP_CLIENT_CONFIG + "proxy_port";
    public static final String PROXY_USERNAME = HTTP_CLIENT_CONFIG + "proxy_username";
    public static final String PROXY_PASSWORD = HTTP_CLIENT_CONFIG + "proxy_password";
    public static final String PROXY_PROTOCOL = HTTP_CLIENT_CONFIG + "proxy_protocol";
