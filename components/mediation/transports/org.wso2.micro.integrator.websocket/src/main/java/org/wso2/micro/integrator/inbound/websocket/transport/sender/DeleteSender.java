...
public class DeleteSender implements InboundResponseSender {

    private Log log = LogFactory.getLog(DeleteSender.class);
    private InboundWebsocketSourceHandler sourceHandler;

    public DeleteSender(InboundWebsocketSourceHandler sourceHandler) {
