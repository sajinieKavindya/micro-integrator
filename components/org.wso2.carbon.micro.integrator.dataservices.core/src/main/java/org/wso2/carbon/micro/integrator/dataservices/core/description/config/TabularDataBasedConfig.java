 ...
 *
 */
package org.wso2.carbon.micro.integrator.dataservices.core.description.config;
...
import org.wso2.carbon.micro.integrator.dataservices.core.DataServiceFault;
import org.wso2.carbon.micro.integrator.dataservices.core.datasource.DataColumn;
import org.wso2.carbon.micro.integrator.dataservices.core.datasource.DataRow;
import org.wso2.carbon.micro.integrator.dataservices.core.datasource.DataTable;
import org.wso2.carbon.micro.integrator.dataservices.core.datasource.FixedDataRow;
import org.wso2.carbon.micro.integrator.dataservices.core.datasource.TabularDataBasedDS;
import org.wso2.carbon.micro.integrator.dataservices.core.engine.DataService;
import org.wso2.carbon.micro.integrator.dataservices.core.odata.ODataDataHandler;
import org.wso2.carbon.micro.integrator.dataservices.core.odata.ODataServiceFault;
import org.wso2.carbon.micro.integrator.dataservices.sql.driver.TConnectionFactory;
import org.wso2.carbon.micro.integrator.dataservices.sql.driver.TCustomConnection;
import org.wso2.carbon.micro.integrator.dataservices.sql.driver.parser.Constants;
import org.wso2.carbon.micro.integrator.dataservices.sql.driver.processor.reader.DataCell;
import org.wso2.carbon.micro.integrator.dataservices.sql.driver.query.ColumnInfo;
...
public class TabularDataBasedConfig extends SQLConfig {
	...
	public static class CustomSQLDataSource implements DataSource {
		...
		public class SQLParserCustomDataSourceAdapter implements
			...
			@Override
			public org.wso2.carbon.micro.integrator.dataservices.sql.driver.processor.reader.DataTable getDataTable(
			...
			public class SQLParserDataTableAdapter extends
                    org.wso2.carbon.micro.integrator.dataservices.sql.driver.processor.reader.DataTable {
                ...
                @Override
				public void addRow(org.wso2.carbon.micro.integrator.dataservices.sql.driver.processor.reader.DataRow row)
				            throws SQLException {
					try {
				...
				private DataRow convertDataRow(org.wso2.carbon.micro.integrator.dataservices.sql.driver.processor.reader.DataRow row) {
				...
				private org.wso2.carbon.micro.integrator.dataservices.sql.driver.processor.reader.DataRow convertDataRow(
						int rowId, DataRow row) {
					org.wso2.carbon.micro.integrator.dataservices.sql.driver.processor.reader.DataRow result =
						new org.wso2.carbon.micro.integrator.dataservices.sql.driver.processor.reader.DataRow(rowId);
				...
				@Override
				public Map<Integer, org.wso2.carbon.micro.integrator.dataservices.sql.driver.processor.reader.DataRow> applyCondition(
					...
					try {
						...
						Map<Integer, org.wso2.carbon.micro.integrator.dataservices.sql.driver.processor.reader.DataRow> result =
							new HashMap<Integer, org.wso2.carbon.micro.integrator.dataservices.sql.driver.processor.reader.DataRow>();
				...
				@Override
				public Map<Integer, org.wso2.carbon.micro.integrator.dataservices.sql.driver.processor.reader.DataRow> getRows()
				            throws SQLException {
					try {
					    Map<Integer, org.wso2.carbon.micro.integrator.dataservices.sql.driver.processor.reader.DataRow> result =
						    new HashMap<Integer, org.wso2.carbon.micro.integrator.dataservices.sql.driver.processor.reader.DataRow>();
				...
				@Override
				public void updateRows(org.wso2.carbon.micro.integrator.dataservices.sql.driver.processor.reader.DataRow... data)
				        throws SQLException {
					Map<Long, DataRow> updateValues = new HashMap<Long, DataRow>();
					for (org.wso2.carbon.micro.integrator.dataservices.sql.driver.processor.reader.DataRow row : data) {
