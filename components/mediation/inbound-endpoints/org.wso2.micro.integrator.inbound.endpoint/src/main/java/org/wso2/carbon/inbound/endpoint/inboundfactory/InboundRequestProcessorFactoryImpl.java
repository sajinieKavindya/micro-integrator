...
import org.wso2.carbon.inbound.endpoint.protocol.httpws.InboundHttpWebsocketListener;
...
public class InboundRequestProcessorFactoryImpl implements InboundRequestProcessorFactory {
    ...
    public static enum Protocols {jms, file, http, https, hl7, kafka, mqtt, rabbitmq, ws, wss, grpc, httpws}
